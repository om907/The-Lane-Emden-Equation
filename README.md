...
<!-- The parameter $\beta(r)=\left|\frac{\dfrac{dP}{dr}}{\rho(r)g(r)}\right|+1$ is introduced as a measure of the deviation from hydrostatic equilibrium.--> 
When the pressure gradient exactly balances gravity, $\beta(r)=2.$ If your intended equilibrium value is instead 1, define it as $\beta(r)=\left|\frac{\dfrac{dP}{dr}}{\rho(r)g(r)}+1\right|,$ which satisfies $\beta(r)=0$ for perfect hydrostatic equilibrium. (This latter definition is generally a more natural error measure.)
